...
import { MapPin, Music2, Radio, Plus, Settings } from "lucide-react";
...
export function RadioClient() {
  ...
  const { activeStationId, pendingStationId } = useRadio();
  ...
  return (
    <div className="space-y-6">
      <BangersPageHero
        ...
        kicker="Radio room"
        chips={[
          { icon: Radio, label: "Stations" },
          { icon: Music2, label: "Continuous Mix" },
          { icon: MapPin, label: "Long Beach Mix" },
        ]}
      />

      <div className="bangers-section-bar flex flex-wrap items-center justify-between gap-4">
